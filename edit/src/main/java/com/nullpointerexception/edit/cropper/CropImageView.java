...
package com.nullpointerexception.edit.cropper;
...
import com.nullpointerexception.edit.cropper.cropwindow.edge.Edge;
import com.nullpointerexception.edit.cropper.cropwindow.handle.CropWindowEdgeSelector;
import com.nullpointerexception.edit.cropper.util.CatchEdgeUtil;
import com.nullpointerexception.edit.cropper.util.UIUtil;
...
public class CropImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public boolean is_TO_Cut = false;
    ...
    private void init(@NonNull Context context) {
        ...
        mGuidelinePaint.setColor(Color.parseColor("#66FFFFFF"));
    ...
    private boolean shouldGuidelinesBeShown() {
        return ((mGuidelinesMode == GUIDELINES_ON)
                || ((mGuidelinesMode == GUIDELINES_ON_TOUCH) && isPress == true));
    }
